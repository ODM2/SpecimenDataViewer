...
from api.querysets import AffiliationQuerySet, RelatedActionManager, ResultManager, \
...
database_manager = settings.DATABASES['ODM2Samples']['ENGINE']

for model in classes:
    if database_manager == u'sql_server.pyodbc' or u'django_pyodbc':
